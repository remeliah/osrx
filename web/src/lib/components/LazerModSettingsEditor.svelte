<script lang="ts">
  ...
  type FieldDef = { key: string, label: string, type: 'number' | 'checkbox' | 'text', hint?: string };
  const SCHEMAS: Record<string, FieldDef[]> = {
    ...
    MG: [
      { key: 'attraction_strength', label: 'Attraction Strength', type: 'number' }
    ],
    RP: [
      { key: 'repulsion_strength', label: 'Repulsion Strength', type: 'number' }
    ],
    MR: [
      { key: 'reflection', label: 'Reflection', type: 'text' }
    ],
    RD: [
      { key: 'angle_sharpness', label: 'Angle Sharpness', type: 'number' }
    ],
    WG: [
    ...
    SD: [
      { key: 'fail_on_slider_tail', label: 'Fail on Slider Tail', type: 'checkbox' }
    ],
    ...
    PF: [
      { key: 'require_perfect_hits', label: 'Require Perfect Hits', type: 'checkbox' }
    ],
    SR: [
