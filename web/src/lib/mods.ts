...
export const MOD_LABELS: Record<string, string> = {
  NF: 'NF',  EZ: 'EZ',  NV: 'NV',  HD: 'HD',  HR: 'HR',
  SD: 'SD',  DT: 'DT',  RX: 'RX',  HT: 'HT',  NC: 'NC',
  FL: 'FL',  AT: 'AT',  SO: 'SO',  AP: 'AP',  PF: 'PF',
  K4: '4K',  K5: '5K',  K6: '6K',  K7: '7K',  K8: '8K',
  FI: 'FI',  RD: 'RD',  CN: 'CN',  TD: 'TD',  K9: '9K',
  K1: '1K',  K3: '3K',  K2: '2K',  V2: 'V2',  MR: 'MR',
};

const MOD_ICON_MAP: Record<string, string> = {
  NF: 'no-fail', EZ: 'easy', HD: 'hidden', HR: 'hard-rock', SD: 'sudden-death',
  DT: 'double-time', RX: 'relax', HT: 'half-time', NC: 'nightcore', FL: 'flashlight',
  AT: 'autoplay', SO: 'spun-out', AP: 'autopilot', PF: 'perfect', FI: 'fade-in',
  RD: 'random', CN: 'cinema', MR: 'mirror', K1: 'one-key', K2: 'two-keys',
  K3: 'three-keys', K4: 'four-keys', K5: 'five-keys', K6: 'six-keys',
  K7: 'seven-keys', K8: 'eight-keys', K9: 'nine-keys', K10: 'ten-keys',
  TR: 'transform', WG: 'wiggle', SI: 'spin-in', GR: 'grow', DF: 'deflate',
  WU: 'wind-up', WD: 'wind-down', TC: 'traceable', BR: 'barrel-roll',
  AD: 'approach-different', FF: 'floating-fruits', MU: 'muted', NS: 'no-scope',
  MG: 'magnetised', RP: 'repel', AS: 'adaptive-speed', FR: 'freeze-frame',
  BU: 'bubbles', SY: 'synesthesia', DP: 'depth', BM: 'bloom', SR: 'simplified-rhythm',
  TP: 'target-practice', DA: 'difficulty-adjust', CL: 'classic', AL: 'alternate',
  SW: 'swap', SG: 'single-tap', IN: 'invert', CS: 'constant-speed', HO: 'hold-off',
  CO: 'cover', AC: 'accuracy-challenge', BL: 'blinds', ST: 'strict-tracking', NR: 'no-release',
  '1K': 'one-key', '2K': 'two-keys', '3K': 'three-keys', '4K': 'four-keys',
  '5K': 'five-keys', '6K': 'six-keys', '7K': 'seven-keys', '8K': 'eight-keys',
  '9K': 'nine-keys', '10K': 'ten-keys', DC: 'daycore'
};
